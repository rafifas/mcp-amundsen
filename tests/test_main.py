...
def test_get_table_columns(mock_table_client, mock_metadata_processor):
    ...
    mock_table_client.get_metadata.assert_called_once_with("db", "schema", "table", "gold")
...
def test_get_table_lineage_info(mock_table_client):
    ...
    mock_table_client.get_lineage.assert_called_once_with("db", "schema", "table", 10, "both", "gold")
...
def test_get_table_dashboard_info(mock_table_client, mock_metadata_processor):
    ...
    mock_table_client.get_dashboards.assert_called_once_with("db", "schema", "table", "gold")
...
def test_get_table_dashboard_questions(mock_table_client):
    ...
    mock_table_client.questions.assert_called_once_with("db", "schema", "table", "dash", 10, "gold")
...
def test_get_table_dashboard_question_query(mock_table_client):
    ...
    mock_table_client.question_detail.assert_called_once_with("db", "schema", "table", "dash", "question", "gold")

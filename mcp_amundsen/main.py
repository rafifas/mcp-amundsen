...
@mcp.tool()
def get_table_columns(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> dict[str, Any]:
    """
    ...
    :param cluster: The Amundsen cluster name.
    :return: A dictionary containing simplified column information.
    """
    table_data = table_client.get_metadata(database, schema_name, table_name, cluster)
    return metadata_processor.extract_columns(table_data)


@mcp.tool()
def get_table_date_range(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> dict[str, Any]:
    """
...
@mcp.tool()
def get_table_code_url(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> str:
    """
...
@mcp.tool()
def get_table_airflow_url(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> str:
    """
...
@mcp.tool()
def get_table_schedule(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> str:
    """
...
@mcp.tool()
def get_table_storage_location(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> str:
    """
...
@mcp.tool()
def get_table_owners(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> list[str] | dict[str, Any]:
    """
...
def get_table_lineage_info(
    ...
    """
    return table_client.get_lineage(database, schema_name, table_name, depth, direction, cluster)


@mcp.tool()
def get_table_dashboard_info(database: str, schema_name: str, table_name: str, cluster: str = "gold") -> list[dict[str, Any]] | dict[str, Any]:
    """
    ...
    """
    dashboard_data = table_client.get_dashboards(database, schema_name, table_name, cluster)
    return metadata_processor.extract_dashboards(dashboard_data)


@mcp.tool()
def get_table_dashboard_questions(
    database: str, schema: str, table: str, dashboard_name: str, limit: int = 10, cluster: str = "gold"
    ...
    """
    questions = table_client.questions(database, schema, table, dashboard_name, limit, cluster)
    response = []
...
def get_table_dashboard_question_query(
    database: str, schema: str, table: str, dashboard_name: str, question_name: str, cluster: str = "gold"
) -> dict[str, Any]:
    """
    ...
    """
    question = table_client.question_detail(database, schema, table, dashboard_name, question_name, cluster)
